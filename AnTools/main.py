...
def parse_args():
    ...
    parser.add_argument('--query_type', type=str, default='embeddings_clip-vit-base-patch32', help='Choice= {embeddings_clip-vit-base-patch32, embeddings_mobile-clip-BLT, embeddings_SPA}')
